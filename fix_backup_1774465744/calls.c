...
[SYS_send] = (syscall_t) syscall_sys_send_wrapper;
[SYS_recv] = (syscall_t) syscall_sys_recv_wrapper;
// ...etc
#pragma clang diagnostic pushn#pragma clang diagnostic ignored "-Wcast-function-type-mismatch"
#include <string.h>
#include "debug.h"
